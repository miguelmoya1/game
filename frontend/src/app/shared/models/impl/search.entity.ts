import { Search } from '../../types/impl/search.type';
...
export class SearchResponseEntity {
  ...
  private constructor(items: SearchEntity[], places: SearchEntity[], sets: SearchEntity[]) {
    this.items = items;
    this.places = places;
    this.sets = sets;
  }

  public static create(items: SearchEntity[], places: SearchEntity[], sets: SearchEntity[]) {
