...
export const mapPlayerToEntity = (data: unknown) => {
  if (!isPlayerDto(data)) {
    ...
    throw new TypeError('Invalid data structure received. Cannot map to Player entity.');
  }
...
export const mapPlayerArrayToEntityArray = (data: unknown) => {
  if (!isPlayerDtoArray(data)) {
    ...
    throw new TypeError('Invalid data structure received. Cannot map to Player[] entity array.');
  }
