...
export const getEmptyEffectForm = () =>
  new FormGroup({
    ...
    value: new FormControl<number | null>(null, { validators: [Validators.pattern(/^-?\d*\.?\d+$/)] }),
    ...
    minimumItems: new FormControl<number | null>(0, { validators: [Validators.required, Validators.min(0)] }),
  });
